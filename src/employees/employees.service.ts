...
// import { UpdateEmployeeDto } from './dto/update-employee.dto'; // will use prisma schemas in place of DTO
...
export class EmployeesService {
  ...
  async find(name: string) {
    console.log(" in employee.Service" , name );
    const emp = this.databaseService.employee.findFirst({ where: { name } });
    console.log("emp : ", emp);
    return emp;
  }
